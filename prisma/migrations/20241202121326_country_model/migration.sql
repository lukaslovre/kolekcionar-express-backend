...
INSERT INTO "new_Item" ("cijena", "duljina", "godina", "groupId", "id", "kategorijaId", "kralj", "kvaliteta", "limit", "masa", "materijal", "mintage", "naselje", "nazivId", "nominala", "opis", "pick", "promjer", "serija", "sirina", "tip", "valuta", "visina", "vrijemeDodavanja", "vrstaKamena") SELECT "cijena", "duljina", "godina", "groupId", "id", "kategorijaId", "kralj", "kvaliteta", "limit", "masa", "materijal", "mintage", "naselje", "nazivId", "nominala", "opis", "pick", "promjer", "serija", "sirina", "tip", "valuta", "visina", "vrijemeDodavanja", "vrstaKamena" FROM "Item";
DROP TABLE "Item";
